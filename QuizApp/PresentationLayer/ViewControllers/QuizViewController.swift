...
class QuizViewController: UIViewController {
    ...
    private func addConstraints() {
        ...
        landscapeConstraints.append(contentsOf:
            questionIndexLabel.snp.prepareConstraints{
        ...
        landscapeConstraints.append(contentsOf:
            questionTrackerStackView.snp.prepareConstraints{
                $0.top.equalTo(view).offset(width * 0.1711)
                $0.leading.equalTo(view).offset(itemInset)
                $0.trailing.equalTo(view).offset(-1 * itemInset)
            })
        landscapeConstraints.append(contentsOf:
            questionLabel.snp.prepareConstraints{
                $0.top.equalTo(questionTrackerStackView.snp.bottom).offset(width * 0.0660)
                $0.leading.equalTo(view).offset(itemInset)
                $0.trailing.equalTo(view).offset(-1 * ((height / 2) + itemInset))
            })
        landscapeConstraints.append(contentsOf:
            answersStackView.snp.prepareConstraints{
                $0.leading.equalTo(view).offset((height / 2) + itemInset)
                $0.trailing.equalTo(view).offset(-1 * itemInset)
        ...
        portraitConstraints.append(contentsOf:
            questionTrackerStackView.snp.prepareConstraints{
                $0.top.equalTo(view).offset(height * 0.1711)
                $0.leading.equalTo(view).offset(itemInset)
        ...
        portraitConstraints.append(contentsOf:
            questionLabel.snp.prepareConstraints{
                ...
                $0.top.equalTo(questionTrackerStackView.snp.bottom).offset(height * 0.0660)
                $0.width.equalTo(view).inset(itemInset)
            })
        portraitConstraints.append(contentsOf:
            answersStackView.snp.prepareConstraints{
                $0.centerX.equalTo(view)
                $0.top.equalTo(questionLabel.snp.bottom).offset(height * stackviewFromLabelOffsetMultiplier)
                $0.width.equalTo(view).inset(itemInset)
            })
    }
