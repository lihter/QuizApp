...
class QuizViewController: UIViewController {
    ...
    //private var questionTrackerStackView: QuestionTrackerView!
    ...
    private  func buildViews()  {
        ...
        //questionTrackerStackView = QuestionTrackerView(router: router)
    ...
    private func addConstraints() {
        if UIWindow.isLandscape {
            //print("Landscape \(view.bounds.height)")
    ...
    /*Ovo je implementirano da se nebi moglo spammati odgovore,
     prije se je mogl pet put stisnnuti razliciti odgovor na isto
     pitanje zbog delaya.
     Mozda postoji elegantnije rjesenje?*/
    private var answerable: Bool = true
    ...
    @objc private func doneWithQuestion() {
        ...
        //answerable.toggle() //moguce omoguciti ako se bude htjelo recimo u buducnosti vracati na pitanja i omoguciti ponovno odgovaranje ili tako nesto
    }
